...
Drag.prototype = {
  //拖放对象
	...
	_down:function(e){
		this.EP=E.MOUSE(e);
		this.MP={x:this.offsetLeft,y:this.offsetTop};
	...
	_move:function(e){
		...
		var moveleft = (E.MOUSE(e).x-this.EP.x)+this.MP.x<0 ? 0:(E.MOUSE(e).x-this.EP.x)+this.MP.x;
		var movetop = (E.MOUSE(e).y-this.EP.y)+this.MP.y<0 ? 0:(E.MOUSE(e).y-this.EP.y)+this.MP.y;
